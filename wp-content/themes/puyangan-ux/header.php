...
<!-- KISSmetrics tracking snippet --> <script type="text/javascript">var _kmq = _kmq || []; var _kmk = _kmk || 'e171aa7206f5ccf23a263c953c4a075bbacc77d8'; function _kms(u){ setTimeout(function(){ var d = document, f = d.getElementsByTagName('script')[0], s = d.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = u; f.parentNode.insertBefore(s, f); }, 1); } _kms('//i.kissmetrics.com/i.js'); _kms('//doug1izaerwt3.cloudfront.net/' + _kmk + '.1.js'); </script>
						...
						<div class="top-navigation-container container">
							...
							<?php
								...
								if( !empty($top_left_text) ){
									...
									//echo __( $top_left_text , 'gdl_front_end');
