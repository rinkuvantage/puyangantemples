...
if(isset($_POST['registration']))
{
	...
	if(count($error)<=0)
	{
		$sql="INSERT INTO `".$prefix."temple_stars` (`star`, `updated_on`) VALUES ('$star', now())";
		$result = $wpdb->query( $sql );
		if($result==1)
		{
			$url=get_option('home').'/wp-admin/admin.php?page=ManageStars&add=succ';
        ...
        <div class="right donotshowerror">
        	<form action="" method="post" name="register_spcialist" id="register_spcialist">
                <div class="e-mail">
                    ...
                    <div class="field"><input type="text" name="star" value="<?php _e($star); ?>" class="required"/></div>
                </div>
                <div class="clr"></div>
                <div class="e-mail">
