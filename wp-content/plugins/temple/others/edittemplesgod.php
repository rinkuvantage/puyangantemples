        	...
        	<form action="" method="post" name="register_spcialist" id="register_spcialist">
                ...
                <div class="e-mail">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="temple" value="<?php _e($temple); ?>" readonly="readonly"/>
                    </div>
                </div>
                    ...
                    <div class="field">
                        <?php
							...
							?>	<input type="checkbox" value="<?php _e($temgod->id); ?>" name="god_id[]"/><?php _e($temgod->god); ?>
                            	<br/>
                            	<!--<option value="<?php /*_e($temgod->id);*/ ?>"><?php /*_e($temgod->god);*/ ?></option>-->
							<?php		
								}
							?>
                        <!--<input type="hidden" name="god_id" value="<?php _e($god_id); ?>"/>
                        <input type="text" name="god" value="<?php _e($god); ?>"/>-->
                    </div>
                </div>
