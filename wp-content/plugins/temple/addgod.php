...
if(isset($_POST['registration']))
{
	...
	if(count($error)<=0)
	{
		$sql="INSERT INTO `".$prefix."temple_god` (`god`, `updated_on`) VALUES ('$god', now())";
		$result = $wpdb->query( $sql );
		if($result==1)
		{
			$url=get_option('home').'/wp-admin/admin.php?page=ManageGod&add=succ';
        ...
        <div class="right donotshowerror">
        	<form action="" method="post" name="register_spcialist" id="register_spcialist">
                <div class="e-mail">
                    ...
                    <div class="field"><input type="text" name="god" class="required" value="<?php _e($god); ?>"/></div>
                </div>
                <div class="clr"></div>
                <div class="e-mail">
